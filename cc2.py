...
CLASS_INCHARGE_MAP = {
    "1st Year": "aids1_class_incharge@example.com",
    "2nd Year": "aids2_class_incharge@example.com",
    "3rd Year": "aids3_class_incharge@example.com",
    "4th Year": "aids4_class_incharge@example.com",
}

HOD_EMAIL = "hod_aids@example.com"          # Same HOD for all years
PRINCIPAL_EMAIL = "principal@example.com"   # Same Principal
...
def home():
    ...
    <head>
        ...
        <style>
            * { box-sizing: border-box; font-family: system-ui, sans-serif; }
            ...
            .header {
                width: 100%; background: #0d47a1; color: white;
            ...
            .container {
                ...
                padding: 24px 28px; margin-top: 120px;
                box-shadow: 0 18px 45px rgba(0,0,0,.25);
            }
            input, select {
                width: 100%; padding: 9px 11px;
                border-radius: 10px; border: 1px solid #cfd8dc;
    ...
    <body>
        <div class="header">GYAN GANGA COLLEGE OF TECHNOLOGY</div>

        <div class="container">
            <h2 style="text-align:center; color:#0d47a1;">🪪 Gate Pass Request</h2>
            ...
            <form method="POST" action="/submit">
                ...
                <div id="otp-box" style="margin-top:10px;">
                    ...
                    <p id="otp-status" style="font-size:14px;margin-top:6px;"></p>

                    <button id="resend-btn" type="button" onclick="resendOTP()" disabled>
                        Resend OTP (30s)
                    </button>
                </div>
