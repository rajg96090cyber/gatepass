...
def verify_qr():
    ...
    # 4) Check: sabne approve kiya hai kya?
    if (
        req[9] == "Approved" and    # Class Incharge
        req[10] == "Approved" and   # HOD
        req[11] == "Approved"       # Principal
    ):
        ...
        <p>All three approvals (Class Incharge, HOD, Principal) are required
